...
import {
  useAccountMetrics,
  useDailyPnL,
} from "../../../hooks/analytics/index.js";
import {
  IDailyPnL,
  IStrategyPerformanceProps,
} from "../types/strategyPerformance.types.js";
...
const StrategyPerformance = ({ accountId }: IStrategyPerformanceProps) => {
